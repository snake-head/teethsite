...
import vtkAbstractWidget from '@kitware/vtk.js/Widgets/Core/AbstractWidget.js';
import { extractRenderingComponents } from '@kitware/vtk.js/Widgets/Core/WidgetManager.js';
